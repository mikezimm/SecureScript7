...
export function aboutTable( repoLinks: IRepoLinks, showRepoLinks: boolean ) {
    ...
    table.rows.push( createAboutRow('2022-03-05',"1.0.1.05","Close #3, #10 - add importProps functionality, #15 - whitelist, #19 - quick peek tags", showRepoLinks === true ? repoLinks : null ) );
