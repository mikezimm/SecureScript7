 ...
 */
  ...
  * @returns 
  */
 export function buildBannerProps ( wpProps : IMinWPBannerProps, bbs: IBuildBannerSettings, showTricks: boolean ) {
      ...
      */
      ...
      let showBannerGear = wpProps.showBannerGear === false && showTricks !== true ? false : true;

      //Over-rides expand for certain users
      let enableExpandoramic = showTricks === true ? true : wpProps.enableExpandoramic;
